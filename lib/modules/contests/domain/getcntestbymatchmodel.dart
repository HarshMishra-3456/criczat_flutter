class GetContestByMatchId {
  List<GetContestByMatchIdData> data;

  GetContestByMatchId({
    required this.data,
  });

  factory GetContestByMatchId.fromJson(Map<String, dynamic> json) => GetContestByMatchId(
    data: List<GetContestByMatchIdData>.from(json["data"].map((x) => GetContestByMatchIdData.fromJson(x))),
  );
...
class GetContestByMatchIdData {
  ...
  factory GetContestByMatchIdData.fromJson(Map<String, dynamic> json) => GetContestByMatchIdData(
    id: json["_id"],
    match: json["match"],
    name: json["name"],
