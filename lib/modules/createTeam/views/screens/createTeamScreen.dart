...
import 'package:tempalteflutter/modules/createTeam/views/screens/playerProfile.dart';
import 'package:tempalteflutter/modules/createTeam/views/screens/teamPreview.dart';
                                      ...
                                      onTap: () {
                                        // if (!isDisabled) {
                                          ...
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                              builder: (context) => CreateTeamView(isupdate: false),
                                            ),
                                          );
                                        // }
                                      },
    ...
    return BlocBuilder(
      ...
      builder: (context, TeamSelectionBlocState state) {
        ...
        return Opacity(
          ...
          child: Container(
            height: 60,
            color: player.isSelcted! ? AllCoustomTheme.getThemeData().primaryColor.withOpacity(0.4) : AllCoustomTheme.getThemeData().colorScheme.background,
            child: Material(
              color: Colors.transparent,
              child: InkWell(
